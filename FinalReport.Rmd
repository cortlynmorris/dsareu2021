...
set.seed(101)
my_graph <- location_road_name_on_freq %>%
...
set.seed(102)
my_graph <- location_road_name_at_freq %>%
  wordcloud2(shape = 'circle', backgroundColor = "black", minSize = 5)
