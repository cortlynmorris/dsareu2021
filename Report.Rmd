...
```{r rename-STLF-fcast-stationary, echo=FALSE, eval=FALSE}
#Stationary
dif_daily_forecast_values_covid_STLF <- summary(dif_m)

rownames(dif_daily_forecast_values_covid_STLF) <- seq(as.Date("2021/06/01"), 
                                                as.Date("2021/12/31"), "day")
```

```{r STLF-fcast-filter-stationary, echo=FALSE, eval=FALSE}
#Stationary
head(dif_daily_forecast_values_covid_STLF)
```
...
```{r rename-noncovid-STLF-fcast-stationary, echo=FALSE, eval=FALSE}
#Stationary
daily_forecast_values_noncovid_STLF <- summary(p)
...
```{r noncovid-STLF-fcast-filter-stationary, echo=FALSE, eval=FALSE}
#stationary
head(daily_forecast_values_noncovid_STLF)
```
...
```{r monthly-STLF-forecast-ts-decomp-stationary, echo=FALSE, message=FALSE, eval=FALSE}
...
t <- dif_crashes_mts4 %>% #(ERROR: NaNs produced)
  stlf(lambda = 0, h = 8, level=c(80,95)) 
...
q <- season_dif_crashes_mts4.noncovid %>% #ERROR: NaNs produce
  stlf(lambda = 0, h = 23, level=c(80,95)) 
