...
```{r tbats-stationary, echo=FALSE, message=FALSE}
#Stationary
# crashests2
# dif_crashests2<-diff(crashests2)
# z0<-cumsum(c(crashests2[1], dif_fc_tbats_covid2))
...
Yhat <- cumsum(c(crashests2[1],dYhat))
Yhat <- ts(Yhat)
```
...
```{r noncovid-STLF-fcast-filter-stationary, echo=FALSE}
#stationary
head(daily_forecast_values_noncovid_STLF)
```
