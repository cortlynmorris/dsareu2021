...
fcast <- forecast::forecast(covid, 212)
...
fcast.noncovid <- forecast::forecast(noncovid, 671)
...
fcast.2019 <- forecast::forecast(noncovid, 667)
...
fcast.2019 <- forecast::forecast(fit.crashes.2019, h=13)
...
fcast.covid.monthly.2019 <- forecast::forecast(covid.monthly.2019, 13)
