...
### Time Series Plot for Frequency of Daily Crashes From January 2015 to May 2021 (With Pandemic Data)
...
### Time Series Plot for Frequency of Daily Crashes From January 2015 to May 2021 (Without Pandemic Data)
...
#### Basic Prediction (With Pandemic Data)
...
#### Forecasting and Time Series (With Pandemic Data) 
...
#### Basic Prediction (Without Pandemic Data)
...
autoplot(fcast.noncovid) +
  ggtitle("Forecasts of car crashes using regression without pandemic data") +
  xlab("Year") + ylab("Crashes")
```

#### Forecast and Time Series (Without Pandemic Data)
...
#### Forecast and Time Series (With Pandemic Data)
...
### Time Series Forecast of Monthly Crashes (Without Pandemic Data)
