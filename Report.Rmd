...
### Frequency of Crashes by Alcohol Result Type 
...
crashes %>% 
  ...
  mutate(Crash_Date_Month = factor(Crash_Date_Month, 
                                   ...
                                   c("January","February","March", 
                                              ...
                                              "November", "December")))%>%
  ggplot() +
  geom_bar(aes(Crash_Date_Month, fill=Crash_Date_Month), 
  show.legend = FALSE) +
  geom_text(stat="count", aes(x=Crash_Date_Month, 
  label=..count..), vjust=-0.25) +
